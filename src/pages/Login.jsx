      ...
      <div className='w-2/6 my-5 -mt-10 mx-4'>
          ...
          <form className='flex flex-col space-y-3 mb-4' >
            ...
            <div className='flex flex-col'>
              ...
              <input type="password" placeholder='Minimum 8 Characters' name="password" onChange={(e)=>setAdmin({...admin,[e.target.name]:e.target.value})} className='indent-2 border rounded-md border-gray-400 py-2 px-1 bg-gray-50'/>
            </div>
